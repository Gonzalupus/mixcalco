...
* El sistema es amigable con usuarios nuevos en general, y se instala mediante un instalador gráfico independiente llamado Calamares que te lleva paso a paso como el Wizard de instalación en Windows. De manera similar, la instalación de programas se puede hacer a través el instalador gráfico Pamac.
...
* De nuevo, al estar basada en Arch linux, los usuarios de Manjaro podemos echar mano de la [Wiki](https://wiki.archlinux.org/index.php/Main_page_(Espa%C3%B1ol) y de los repositorios mantenidos por la comunidad. Pero además, la comunidad en los [foros](https://forum.manjaro.org/) es bastante amable y es fácil encontrar una solución a los problemas.
